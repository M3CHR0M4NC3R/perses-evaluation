...
java -jar perses_deploy.jar --query-caching false --enable-trec true --input-file input/src/main/java/com/cogvio/time/MutableClock.java --test-script input/src/main/java/com/cogvio/time/falsepositive.sh --output-dir output/src/main/java/com/cogvio/time/
