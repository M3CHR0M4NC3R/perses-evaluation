...
java -jar perses_deploy.jar --query-caching false --input-file input/src/main/java/net/mtu/eggplant/checker/parser_error/Version.java --test-script input/src/main/java/net/mtu/eggplant/checker/parser_error/testcommand.sh --output-dir output/src/main/java/net/mtu/eggplant/checker/parser_error
